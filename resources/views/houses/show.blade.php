...
<div style="display:inline">
    ...
    <br>
    <a href="{{ route('house.edit', $house) }}" class="btn btn-primary btn-lg" tabindex="-1" role="button">Edit</a>
    <br>
    <form action="{{ route('house.delete', $house) }}" method="post" enctype="multipart/form-data">
        @csrf
        @method('DELETE')
